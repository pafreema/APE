...
I used APE for ngVLA and ALMA synthetic observations and initial results (moment 0 maps, spectra, and abundance maps) are found in the Results folder for several tests combining these parameters, with a 1 hour integration: 
